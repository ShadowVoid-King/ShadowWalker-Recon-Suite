...
# -----------------------------------------------------------------------------
# |                      ShadowWalker Recon Script (Kali Edition v0.7)        |
# -----------------------------------------------------------------------------
# | Description:                                                            |
# |   Professional, modular recon and attack framework for Kali Linux.      |
...
# --- Configuration ---
PERM_WORDLIST="/usr/share/seclists/Discovery/DNS/dns-jhaddix.txt"
...
DIRSEARCH_WORDLIST="/usr/share/seclists/Discovery/Web-Content/directory-list-2.3-medium.txt"
...
run_discover() {
    ...
    gospider -S live_hosts.txt -o gospider_output -c 10 -d 5 --other-source --include-subs 2>> "$LOG_FILE"; # Gospider logs are complex to size check simply
